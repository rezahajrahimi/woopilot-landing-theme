...
// Structured data and SEO meta tags are now output via theme hooks in functions.php
...
<main id="main-content" class="landing-page">
    <section class="hero" role="region" aria-labelledby="hero-heading">
        ...
        <div class="container hero-grid">
            <div class="hero-copy">
                <p class="eyebrow">نسل جدید مدیریت فروشگاه</p>
                ...
                <div class="hero-actions">
                    <a href="<?php echo esc_url( get_theme_mod('download_link', '#') ); ?>" class="btn btn-primary" data-cta="download">دانلود از Cafe Bazaar</a>
                    <a href="<?php echo esc_url( get_theme_mod('login_link', '#') ); ?>" class="btn btn-ghost" data-cta="login">ورود به پنل هوشمند</a>
                </div>
